   ...
   <q-page class="flex flex-center bg-gradient">
      <q-card class="q-pa-lg shadow-2" style="width: 400px; max-width: 85vw; border-radius: 10px">
         ...
         <div class="have-an-acc-link-linkto">
            <router-link flat to="login" :class="routerLinkColor">Already have an account?</router-link>
         </div>
      ...
      if (valid) {
         ...
         try {
            ...
            if (res.status === 201) {
               ...
               msg.value.body = "You Successfully Created An Account. Please Check Your emails for verification"
               dialog.value = true
            }
         } catch(err) {
            ...
            if (err.status === 409) {
               ...
               msg.value.body = "This email address is already registered. Please log in or use a different email."
               dialog.value = true
