<template>
  <q-page-container>
    <div>
      <div class="q-row flex justify-content-start">
        <q-btn icon="chevron_left" flat class="back-btn" @click="goBack" />
      </div>
    </div>
    <q-page class="profile-page flex justify-center">
        ...
        <div v-if="!loading" class="tabs-container q-pa-sm q-mt-lg">
          ...
          <q-tab-panels v-model="tab" animated>
            <q-tab-panel name="posts">
              <div v-if="!user.posts || user.posts.length === 0" class="text-grey">
                No posts yet.
              </div>
              <div v-else>
            ...
            <q-tab-panel name="contact">
              <div v-if="!hasContacts" class="text-grey-6 text-center q-pa-md">
                No contact info.
              </div>
